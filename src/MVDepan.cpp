...
#undef ERROR_SIZE
    ...
    *data = d;
    ...
    vsapi->createVideoFilter(out, "DepanAnalyse", data->vi, depanAnalyseGetFrame, depanAnalyseFree, fmParallel, deps, ARRAY_SIZE(deps) - !data->mask /*mask may not exist*/, data, core);
